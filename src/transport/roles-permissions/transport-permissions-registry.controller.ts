...
@ApiTags('Transport / Dynamic Permissions Registry')
@ApiBearerAuth()
@UseGuards(TransportJwtGuard)
@Controller('api/transport/permissions')
export class TransportPermissionsRegistryController {
  constructor(private readonly svc: TransportPermissionsRegistryService) {}
  ...
  createPermission(@Body() dto: CreateTransportCustomPermissionDto) {
  ...
  updatePermission(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateTransportCustomPermissionDto) {
