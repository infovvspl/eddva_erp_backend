 ...
 * `details` verbatim, producing the
 * `{ success:false, error:{ code, message, details } }` envelope without
 * needing a new filter.
 *
 * Defaults to 422 (rule violated). Pass HttpStatus.CONFLICT for state races /
