...
export class AccountsPermissionsRegistryController {
  ...
  createPermission(@Body() dto: CreateAccountsCustomPermissionDto) {
  ...
  updatePermission(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateAccountsCustomPermissionDto) {
