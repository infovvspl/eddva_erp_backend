...
export function isAdmissionAdmin(actor: AdmissionPlatformUser): boolean {
  return (
...
/**
 * Resolves the acting Admission user's permission matrix.
 *
...
export class AdmissionAccessService {
  ...
  async hasPermission(
    ...
    if (isAdmissionAdmin(actor)) return true;
