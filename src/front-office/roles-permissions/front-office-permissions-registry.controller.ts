...
@ApiTags('Front Office / Dynamic Permissions Registry')
@ApiBearerAuth()
@UseGuards(FrontOfficeJwtGuard)
@Controller('api/front-office/permissions')
export class FrontOfficePermissionsRegistryController {
  constructor(private readonly svc: FrontOfficePermissionsRegistryService) {}
  ...
  createPermission(@Body() dto: CreateFrontOfficeCustomPermissionDto) {
  ...
  updatePermission(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateFrontOfficeCustomPermissionDto) {
